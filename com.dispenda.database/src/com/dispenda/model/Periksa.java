...
public class Periksa {
	...
	public Periksa(Integer idPeriksa, String noPeriksa, Date tglPeriksa, String npwpd, String jenisPeriksa,
			Integer kenaikanPersen, Double kenaikan, Date masaPajakDari, Date masaPajakSampai, String no_skp,
			Date tgl_skp, String no_nppd, Date tgl_nppd, Integer idSubPajak, String tipe_skp,
